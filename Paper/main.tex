...
This objective function is non-convex, due to the presence of bivariate quadratic terms (e.g. $-I_{D,t}I_{C,t-1}$). However, it is possible to solve the problem by generating a positive semidefinite\sol{I think that we should just leave it at the previous sentence, as the thing turns our to work anyway}
